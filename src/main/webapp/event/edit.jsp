            ...
            <div class="p-3 py-5">
                ...
                <form method="post" action="">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="password" placeholder="Enter Hold Time"
                               value=""></div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="avatar" placeholder="Enter Fee" value="">
                    </div>
                    <div class="col-md-12">
                        <label class="labels">Profile Picture</label>
                        <input type="text" class="form-control" name="prof_picture" placeholder="Enter Profile Picture Link" value="">
                    </div>
                    <div class="col-md-12">
